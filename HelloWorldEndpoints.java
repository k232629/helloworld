...
public class HelloWorldEndpoints {
    @ApiMethod(name ="greetByMood", path = "greetByMood", httpMethod = HttpMethod.GET)
    public HelloClass greetByMood(@Named("name") String name,@Named("period") String period,@Named("mood") String mood){
        return new HelloClass(name,period,mood);
    }
